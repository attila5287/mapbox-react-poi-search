...
const MarkerSVG = () => (
  ...
  >
    <g filter="url(#filter0_d_2001_2)">
      <path
        d="M84.5254 40.7407C84.5254 63.2412 54.0169 100 43.8475 100C32.7535 100 3.16949 63.2412 3.16949 40.7407C3.16949 18.2403 21.3816 0 43.8475 0C66.3133 0 84.5254 18.2403 84.5254 40.7407Z"
        fill="#43538D"
      />
    </g>
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_2001_2"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect1_dropShadow_2001_2"
          result="shape"
        />
      </filter>
    </defs>
...
const POIMarker = ({ map, feature, category }: { map: mapboxgl.Map; feature: GeoJSON.Feature; category: string }) => {
  ...
  useEffect(() => {
    ...
    // instantiate a new Mapbox Marker()
      ...
      // use the markerContentRef as the content of the marker
      anchor: "bottom",
    })
